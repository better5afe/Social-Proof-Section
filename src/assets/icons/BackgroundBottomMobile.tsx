...
const BackgroundBottomMobile = () => {
	return (
		<svg className='icon bg-bottom-mobile' width='375' height='503' xmlns='http://www.w3.org/2000/svg'>
			<defs>
...
export default BackgroundBottomMobile;
