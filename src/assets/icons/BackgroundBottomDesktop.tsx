...
const BackgroundBottomDesktop = () => {
	return (
		<svg className='icon bg-bottom-desktop' width='1085' height='673' xmlns='http://www.w3.org/2000/svg'>
			<defs>
...
export default BackgroundBottomDesktop;
